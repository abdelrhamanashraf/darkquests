...
import { Gamepad2, LogOut, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-3 py-2 rounded-lg bg-secondary/50 text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors text-sm"
          >
